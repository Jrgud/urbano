...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  const {authorization,logout} = useUser();
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden bg-black duration-300 ease-linear dark:bg-boxdark  static  ${
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <NavLink to="/">
          <img src={'https://envios.pe.urbanoexpress.net/icons/urbano_logo_white.svg'} alt="Logo" />
        </NavLink>
      ...
      <div className="flex items-center gap-3 2xsm:gap-7 justify-end">
        <div className='rounded-full border mx-2 flex justify-center px-4 py-1.5  ms-1'>
          <ul className="flex items-center pe-1">
            {/* <!-- Dark Mode Toggler --> */}
            <DarkModeSwitcher />
            {/* <!-- Dark Mode Toggler --> */} 
          </ul>
          ...
          {/* <!-- User Area --> */}
          <DropdownUser authorization={authorization} logout={logout} />
          {/* <!-- User Area --> */}
        </div>
      </div>
      {/* <!-- SIDEBAR HEADER --> */}
